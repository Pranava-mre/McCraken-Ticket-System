...
## Project Structure
- `server/app.py`: Flask backend app and all routes
- `server/schema.sql`: SQLite schema
- `server/data/tickets.db`: local SQLite DB (auto-created)
- `server/tickets_pdf/<year>/`: generated ticket PDFs
- `client/templates/`: HTML screens
- `client/static/style.css`: frontend styles
